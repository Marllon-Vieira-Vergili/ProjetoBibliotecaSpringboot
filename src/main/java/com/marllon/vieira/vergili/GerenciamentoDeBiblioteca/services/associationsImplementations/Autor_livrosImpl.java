...
//Esse método funcionou.. mas to tentando fazer ele voltar como um DTO agora
...
/*
    ...
    public AutorELivrosResponseDTO associarAutorALivros(AutorELivrosRequestDTO autorELivrosRequestDTO) {
        ...
        return new AutorELivrosResponseDTO(autorEncontrado.getId(), autorEncontrado.getNome(),
                ...
                autorEncontrado.getCidade(), ((List<LivroResponseDTO>) autorEncontrado.getListaLivrosDosAutores());
    }
 */
...
/*
@Override
public List<AutorELivrosResponseDTO> encontrarAutorESeusLivrosAssociados
        (Integer id) {
    ...
    return List.of(new AutorELivrosResponseDTO(autorEncontrado.getId(), autorEncontrado.getNome(),
            autorEncontrado.getEmail(), autorEncontrado.getTelefone(), autorEncontrado.getCidade(),
            autorEncontrado.getListaLivrosDosAutores()));
}
